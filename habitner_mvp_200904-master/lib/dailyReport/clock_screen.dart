...
import 'package:habitner_mvp_200904/dailyReport/dailyReport.dart';
import 'package:habitner_mvp_200904/dailyReport/utile_forClork.dart';
              ...
              children: [
                Row(children: [
                  TextField(autofillHints: <String>["$i_index"], controller: titleTextController, style: TextStyle(fontSize: 15),
                    maxLines: 1,), Expanded(child:Container()), IconButton(onPressed: (){},icon: Icon(Icons.circle, color: Colors.red,))
                ] ),
                Row(children: [
